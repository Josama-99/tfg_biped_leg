...
\midrule
Hip 1 (Flex/Ext) & X & Oficial & 0 & 0 & $\pm$0.79 & 16:1 \\
Hip 2 (Abd/Add) & Y & Makerbase & 0 & -0.04 & $\pm$0.52 & 16:1 \\
...
\begin{itemize}
    \item Flexión de Hip 1 (eje X): 60° = 1.047 rad
    \item Abducción de Hip 2 (eje Y): 0° = 0 rad (simétrica, sin carga lateral)
...
\midrule
Hip 1 (eje X) & 22.46 Nm & 14.7 Nm & \textcolor{red}{Insuficiente} \\
Hip 2 (eje Y) & 0 Nm & 14.7 Nm & \textcolor{green}{Suficiente} \\
Knee (eje Y) & 7.72 Nm & 14.7 Nm & \textcolor{green}{Suficiente} \\
\bottomrule
\end{tabular}
\end{table}

\textbf{Nota:} La articulación Hip 1 excede la capacidad del ODrive (22.46 Nm requeridos vs 14.7 Nm disponibles). Para una sentadilla unipodal (8kg en una pierna), los pares se duplicarían, haciendo que tanto Hip 1 como potencialmente Knee sean insuficientes. Las soluciones incluyen aumentar la relación de reducción a 25:1 o reducir la carga útil/profundidad de la sentadilla.
